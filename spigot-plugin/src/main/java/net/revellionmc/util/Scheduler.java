...
public class Scheduler
{
    ...
    {
        return get().runTaskAsynchronously(Revellion.get(), runnable).getTaskId();
    }
    ...
    {
        return get().scheduleSyncDelayedTask(Revellion.get(), runnable, delay);
    }
    ...
    {
        return get().runTask(Revellion.get(), runnable).getTaskId();
    }
    ...
    {
        return get().runTaskTimer(Revellion.get(), runnable, delayBeforeRepeat, interval * 20).getTaskId();
    }
    ...
    {
        return get().runTaskTimer(Revellion.get(), runnable, 0L, interval).getTaskId();
    }
